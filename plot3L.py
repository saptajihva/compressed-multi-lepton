...
#==================== EDIT THESE ========================#
lumipb = 3158 #pb-1 (10 fb-1)
lumifb = lumipb/1000.0
sqrts  = 13
signalprocess= 'Three Lepton'
signaljets=" with ISR "
...
color_list = ('tomato','darkseagreen','gainsboro','mistyrose','cadetblue','khaki','seagreen','lavender')
...
variable_list_file = "variablelist_3lep.txt"
...
#    label = ROOT.TLatex(labelmargin, 0.84, '#sqrt{s} = ' + str(sqrts) + ' TeV, #int L dt = ' + str(lumifb) + ' fb^{-1}')
#    label.SetTextFont(43)
#    label.SetTextSize(18)
#    label.SetNDC()
#    label.Draw()

    label2 = ROOT.TLatex(0.4, 0.1, signalprocess + signaljets)
