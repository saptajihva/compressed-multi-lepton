...
// Thu May 12 13:55:29 2016 by ROOT version 5.34/25
...
public :
   ...
   Int_t           n_b_TTjets;
   Double_t        ISR_pt;
   Double_t        dphi_ISR_MET;
   Double_t        hadtop_M;
   Double_t        hadtop_PAlongThrust;
   Double_t        ttjets_pt;
   ...
   TBranch        *b_pTbV2;   //!
   TBranch        *b_n_TTjets;   //!
   TBranch        *b_n_b_TTjets;   //!
   TBranch        *b_ISR_pt;   //!
   TBranch        *b_dphi_ISR_MET;   //!
   TBranch        *b_hadtop_M;   //!
   TBranch        *b_hadtop_PAlongThrust;   //!
   TBranch        *b_ttjets_pt;   //!

   SussexBase(TTree *tree=0);
   virtual ~SussexBase();
...
inline SussexBase::SussexBase(TTree *tree) : fChain(0) 
{
...
inline SussexBase::~SussexBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

inline Int_t SussexBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
inline Long64_t SussexBase::LoadTree(Long64_t entry)
{
...
inline void SussexBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("n_TTjets", &n_TTjets, &b_n_TTjets);
   fChain->SetBranchAddress("n_b_TTjets", &n_b_TTjets, &b_n_b_TTjets);
   fChain->SetBranchAddress("ISR_pt", &ISR_pt, &b_ISR_pt);
   fChain->SetBranchAddress("dphi_ISR_MET", &dphi_ISR_MET, &b_dphi_ISR_MET);
   fChain->SetBranchAddress("hadtop_M", &hadtop_M, &b_hadtop_M);
   fChain->SetBranchAddress("hadtop_PAlongThrust", &hadtop_PAlongThrust, &b_hadtop_PAlongThrust);
   fChain->SetBranchAddress("ttjets_pt", &ttjets_pt, &b_ttjets_pt);
   Notify();
}

inline Bool_t SussexBase::Notify()
{
...
inline void SussexBase::Show(Long64_t entry)
{
...
inline Int_t SussexBase::Cut(Long64_t entry)
{
